...
int   DeQueue_client    (Queue_client *);
...
int DeQueue_order (Queue_Order *pq)
{
   ...
   printf ("\t\t\t\t\t\tThank You\n");
   printf ("\t\t\t\t\t  -------------------------------\n");
   printf("\t\t\t\t\t\tSt: Elkhalfawy-Shoubra\n");
   printf("\t\t\t\t\t\t        Owners:\n\t\t\t\t\t\tOmar shaban && Sameh mohamed\n\t\t\t\t\t\tOmnia Mansour && Alaa Ahmed\n\t\t\t\t\t\t          Asmaa Mostafa\n");
   printf ("\t\t\t\t***********************************************\n\n");
...
int   DeQueue_client (Queue_client *qcr)
{
    system ("cls");
...
void Start ()
{
    printf ("\t\t\t\t--------------------------------------------------------------\n");
    printf ("\t\t\t\t\t******************************************\n");
   printf ("\t\t\t\t\t*\t Welcome to Imyay resturant\t *\n");
   printf ("\t\t\t\t\t******************************************\n");
   printf ("\t\t\t\t\t\t St: Elkhalfawy-Shoubra\n");
   printf ("\t\t\t\t\t\t         Owners:\n \t\t\t\t\t\tOmar Shaban && Sameh Mohamed\n\t\t\t\t\t\tOmnia Mansour && Alaa Ahmed\n\t\t\t\t\t\t    Asmaa Mostafa\n");
   printf ("\t\t\t\t--------------------------------------------------------------\n\n\n");
...
void get_dessert(Order *r)
{
    ...
    else
    {
      strcpy (r->desert,dessert[dessert_menu-1]);
       ...
       money+=r->sum;
        fdessert=fopen("resturant.txt","a");
